...
void leerNombre() {
  ...
  if (tryReadMifareClassicBlockASCII(4, nombre)) {
    Serial.print("Nombre (MIFARE Classic, bloque 4): ");
    Serial.println(nombre);
    delay(1000);
    return;
  }

  Serial.println("No pude leer el nombre. Puede que esté en otro bloque/página o con claves cambiadas.");
  delay(800);
}
